...
app.config(function ($routeProvider) {
    $routeProvider.
        when('/', {controller: HomeCtrl, templateUrl: 'apex/AngularBSHome'}).
        when('/contacts', {controller: ContactListCtrl, templateUrl: 'apex/AngularBSList'}).
        when('/edit/:contactId', { controller: ContactDetailCtrl, templateUrl: 'apex/AngularBSDetail'}).
        when('/new', { controller: ContactCreateCtrl, templateUrl: 'apex/AngularBSDetail'}).
...
//        when('/contacts', {controller: ContactListCtrl, templateUrl: 'partials/contact/list.html'}).
        when('/view/:contactId', {controller: ContactViewCtrl, templateUrl: 'apex/AngularBSView'}).
